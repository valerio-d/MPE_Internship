...
- **CleanAp** — Clean Aperture photometry
- **NeighborSub** — Neighbor Subtraction pipeline
- **PSFStrip** — strips PSF-modeled contaminants from the image
- **AperPure** — pure aperture photometry
- **LegacyClean** — clean photometry from Legacy Survey data
- **HostPhot** — host galaxy photometry (nod to the original quasar scope)
- **DeContour** — decontamination via contour-matched PSF subtraction
- **SkyStrip** — strips the sky of contaminating neighbors
- **GalaxyPeel** — peels away foreground sources
- **AperScrub** — scrubs apertures clean of neighbor flux
- **FluxNet** — clean flux extraction from noisy fields
- **NeighborMask** — masks and subtracts neighboring sources
...
**Azimuthal surface brightness profile** — Boötes field (RA 213.7052, Dec +53.1234)
Per-annulus flux decomposition in mag/arcsec².
![Surface brightness profile](assets/screenshots/06_surface_brightness_profile.png)
...
6. Contour plots — original and synthetic image
...
10. Azimuthal surface brightness profile
